                    ...
                    {isAccepted(userId, user) ? (
                      ...
                      <span className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          type="button"
                          className="text-white bg-orange-500 hover:bg-orange-500 focus:ring-4 focus:ring-orange-500 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-orange-500 dark:hover:bg-orange-500 focus:outline-none dark:focus:ring-orange-500"
                        >
                          Retry
                        </button>
                      </span>
